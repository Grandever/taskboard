...
export class TaskForm implements OnInit, OnChanges {
  ...
  private initializeForm() {
    ...
    this.taskForm = this.fb.group({
      ...
      status: [this.taskToEdit?.status || TaskStatus.TODO, [Validators.required]], // Default to 'todo'
      priority: [this.taskToEdit?.priority || TaskPriority.MEDIUM, [Validators.required]], // Default priority
